            ...
            <div class="col-12 col-md-6">
              <table class="table table-striped table-bordered">
                <tbody>
                  <tr>
                    <th>First name</th>
                    <th>{{$reservation->fname}}</th>
                  </tr>
                  <tr>
                    <th>Last name</th>
                    <th>{{$reservation->lname}}</th>
                  </tr>
                  <tr>
                    <th>Occupants</th>
                    <th>{{$reservation->occupants}}</th>
                  </tr>  
                  <tr>
                    <th>Phone</th>
            ...
            <div class="col-12 col-md-6">
              <table class="table table-striped table-bordered">
                <tbody>
                  <tr>
                    <th>Checkin date</th>
                    <th>{{$reservation->checkin}} {{$reservation->checkin_time}}</th>
                  </tr>
                  <tr>
                    <th>Checkout date</th>
                    <th>{{$reservation->checkout}} {{$reservation->checkout_time}}  </th>
                  </tr>
                  <tr>
                    <th>Room</th>
                    <th><a href="{{route('room.show',$reservation->room->id)}}">{{$reservation->room->name}}</a></th>
                  </tr>
                  <tr>
                    <th>Room Rate</th>
                    <th>{{$reservation->room_rate}}</th>
                  </tr>
                  <tr>
